package com.Primitives
{
	...
	public class PrimitiveBurst extends BasePrimitive
	{
		public function PrimitiveBurst():void
		{
			super();
		}		
		...
		override protected function updateDisplayList(unscaledWidth:Number,unscaledHeight:Number):void
		{
			...
			DrawUtils.burst(this,unscaledWidth/2,unscaledHeight/2,points,(maxSize/2)/ratio,(maxSize/2),angle);	
